...
import static org.openjdk.jmc.console.ui.shenandoahvisualizer.Colors.*;
...
public class RegionStat {
	...
	public boolean equals(Object o) {
		...
		if (Float.compare(that.liveLvl, liveLvl) != 0)
			return false;
		if (Float.compare(that.usedLvl, usedLvl) != 0)
			return false;
		if (Float.compare(that.tlabLvl, tlabLvl) != 0)
			return false;
		if (Float.compare(that.gclabLvl, gclabLvl) != 0)
			return false;
		if (Float.compare(that.sharedLvl, sharedLvl) != 0)
			return false;
